...
get_business_count <- function(suburb){
  ...
  if (length(business_subset) > 0){
    no = business_subset[[4]] ###### require update when changing map type
  }
  return(no)
}
                                      ...
                                      div(id = 'comparison_panel',
                                          ...
                                          wellPanel(id = 'row06',
                                                    ...
                                                    fluidRow(
                                                      ...
                                                      column(4,
                                                             div(HTML({paste('<p style = "font-size:1.5rem; color:black; font-weight:bold; text-align: center;margin-left: -100px; margin-right: -100px">Lenbanese Restaurants', '</p>')}))
                                                      ),
                                                      column(4,
